...
export default function Stage({
  ...
  useEffect(() => {
    ...
    /**
     * Decisão do cliente: a rolagem 3D é a experiência principal do site e
     * deve aparecer por padrão, mesmo em máquinas com "reduzir animação"
     * ativado no sistema operacional (é uma configuração comum do Windows,
     * nem sempre ligada de propósito por quem visita o site). Continuamos
     * respeitando a preferência para o CSS de revelação de texto
     * (SmoothScroll.tsx), só não para a cena 3D em si.
     */
     ...
     */
    let slowFrames = 0;
    // Limiar deliberadamente alto: só desliga a cena num travamento real e
    // contínuo (~10s), nunca por lentidão passageira. A cena 3D é a
    // experiência principal — na dúvida, ela fica.
